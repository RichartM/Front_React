...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      setIsArrowVisible(window.scrollY <= 50);
    };
  ...
  return (
    <>
      ...
      <div style={{ marginTop: "80px" }}>
        {/* Hero */}
        <div className="text-center" style={{ position: "relative", height: "90vh", width: "100%", overflow: "hidden" }}>
          <img
            src={bgImage}
            alt="Carro"
            style={{ top: 0, left: 0, width: "100%", height: "100%", objectFit: "cover", zIndex: -1 }}
          />
          <div
            style={{
              position: "absolute",
          ...
          >
            ...
            <p className="text" style={{ color: '#018180', fontWeight: 'bold' }}>
              REVISA NUESTRO CATÁLOGO Y BENEFÍCIATE CON NUESTROS SERVICIOS
            </p>
          </div>
          <div
        ...
        <div className="text-center p-5" style={{ backgroundColor: "#f8f9fa" }} data-aos="fade-up">
          <h3 className="mb-4" style={{ fontSize: "2rem", color: "#018180" }}>
            ¿Tienes una marca en mente?
          </h3>
          <p className="text" style={{ fontSize: "1.2rem", textAlign: "justify" }}>
            Descubre una amplia selección de marcas en un solo lugar. En nuestra agencia, trabajamos con diversas marcas
            reconocidas para ofrecerte productos de calidad, garantía y estilo.
          </p>
        </div>
        ...
        <div className="text-center p-5" data-aos="fade-up">
          ...
          <p>No solo basta con tener un auto, debes darle mantenimiento:</p>
          ...
          <h6 className="text mb-4" style={{ color: '#018180' }}>
            Explora nuestros servicios y elige la opción que mejor se adapte a ti. ¡Tu auto merece lo mejor!
          </h6>
        </div>
