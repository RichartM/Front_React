...
const servicios = ["Mantenimiento", "Reparaciones", "Lavado", "Cambio de Aceite"];
...
const ServiciosDropdown = () => {
  return (
    <DropdownContainer>
      <StyledDropdownToggle>Servicios</StyledDropdownToggle>
      <DropdownMenuHorizontal>
        {servicios.map((servicio, index) => (
          <StyledDropdownItem key={index} onClick={() => console.log(`Seleccionaste ${servicio}`)}>
            {servicio}
          </StyledDropdownItem>
        ))}
      </DropdownMenuHorizontal>
